 ...
 */
class FootprintAttachment extends \PartKeepr\Footprint\FootprintAttachment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'type', 'filename', 'originalname', 'mimetype', 'size', 'description', 'footprint');
    }
