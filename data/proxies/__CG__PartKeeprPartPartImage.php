 ...
 */
class PartImage extends \PartKeepr\Part\PartImage implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'type', 'filename', 'originalname', 'mimetype', 'size', 'part');
    }
