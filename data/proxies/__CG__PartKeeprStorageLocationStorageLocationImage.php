 ...
 */
class StorageLocationImage extends \PartKeepr\StorageLocation\StorageLocationImage implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'type', 'filename', 'originalname', 'mimetype', 'size', 'storageLocation');
    }
