 ...
 */
class Footprint extends \PartKeepr\Footprint\Footprint implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function setCategory(\PartKeepr\FootprintCategory\FootprintCategory $category)
    {
        $this->__load();
    ...
    public function setImage(\PartKeepr\Footprint\FootprintImage $image)
    {
        $this->__load();
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'description', 'category', 'image', 'attachments');
    }
