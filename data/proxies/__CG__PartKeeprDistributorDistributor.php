...
namespace Proxies\__CG__\PartKeepr\Distributor;

/**
 * THIS CLASS WAS GENERATED BY THE DOCTRINE ORM. DO NOT EDIT THIS FILE.
 */
class Distributor extends \PartKeepr\Distributor\Distributor implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'address', 'url', 'phone', 'fax', 'email', 'comment');
    }
