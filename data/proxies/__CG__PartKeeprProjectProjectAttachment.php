 ...
 */
class ProjectAttachment extends \PartKeepr\Project\ProjectAttachment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'type', 'filename', 'originalname', 'mimetype', 'size', 'description', 'project');
    }
